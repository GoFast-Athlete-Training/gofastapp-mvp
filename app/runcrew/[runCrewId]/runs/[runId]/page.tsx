      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-6 sm:py-8">
        <div className="bg-white rounded-lg shadow p-6 mb-6">
          <div className="space-y-4">
            ...
            {run.stravaMapUrl && (
              <div>
                <h2 className="text-sm font-medium text-gray-500 mb-2">Route Map</h2>
                <a
                  href={run.stravaMapUrl}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center gap-2 px-4 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-sm font-semibold transition"
                >
