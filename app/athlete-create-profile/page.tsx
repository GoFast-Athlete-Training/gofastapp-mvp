        ...
        <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8">
          <div className="text-center mb-8">
            ...
            <p className="text-gray-600 text-sm">
              Claim your identity in three quick fields. Training details come later when we tailor your plan.
            </p>
          </div>
          ...
          <ul className="space-y-4 mb-8 text-left text-gray-700 text-sm">
            <li className="flex gap-3">
              ...
              <span>
                <strong className="text-gray-900">Your GoFast handle</strong> — how others find you.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center text-lg">
              ...
              <span>
                <strong className="text-gray-900">Your name</strong> — confirm what Google gave us.
              </span>
            </li>
            <li className="flex gap-3">
              <span className="flex-shrink-0 w-8 h-8 rounded-lg bg-orange-100 flex items-center justify-center text-lg">
              ...
              <span>
                <strong className="text-gray-900">Your city</strong> — where you run from.
              </span>
            </li>
          </ul>
    ...
    <div className="min-h-screen bg-gray-100 flex items-center justify-center p-6">
      <div className="max-w-lg w-full bg-white rounded-2xl shadow-lg p-8">
        <div className="text-center mb-8">
          ...
          <p className="text-gray-600 text-sm">
            Claim your handle, confirm your name, and tell us your city — then let&apos;s go.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-5">
          ...
          <div className="pt-2">
            ...
            <p className="text-center text-sm text-gray-500 mt-3">
              Training details (age, gender, sport, pace) come later when we tailor your plan.
            </p>
          </div>
        </form>
      </div>
