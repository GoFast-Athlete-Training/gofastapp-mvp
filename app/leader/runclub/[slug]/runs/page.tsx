...
export default function RunClubLeaderRunsPage() {
  ...
  useEffect(() => {
    const unsub = onAuthStateChanged(auth, async (user) => {
      if (!user) {
        router.replace(`/signup?redirect=/leader/runclub/${slug}/runs`);
        return;
      }
      try {
        await load();
  ...
  return (
    <RunClubLeaderShell clubName={clubName} clubSlug={slug} active="runs">
      <div className="mb-6">
        <h2 className="text-xl font-bold text-gray-900">Set your runs</h2>
