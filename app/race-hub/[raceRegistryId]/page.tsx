                  ...
                  <ul className="space-y-4">
                    {shakeouts.map((sh) => {
                      ...
                      const timeLabel = (() => {
                        ...
                        const min = sh.startTimeMinute != null
                          ? String(sh.startTimeMinute).padStart(2, "0")
                          : "00";
                        ...
                        >
                          ...
                          <div className="p-4 sm:p-5">
                            ...
                            <div className="mt-4 flex flex-wrap items-center gap-2">
                              <button
                                type="button"
                                onClick={() => void setShakeoutRunRsvp(sh.id, "going")}
                              ...
                              <button
                                type="button"
                                onClick={() => void setShakeoutRunRsvp(sh.id, "not-going")}
                                className={`px-4 py-2 rounded-lg text-sm font-semibold transition-colors ${
                                  isCantGo
