...
export default function RaceHubJoinSignupExplainerPage() {
  ...
  const [fetchingRace, setFetchingRace] = useState(true);
  ...
  useEffect(() => {
    ...
    async function fetchRace() {
      try {
        ...
        console.error("Race signup explainer:", err);
  ...
  const handleGoogleSignUp = async () => {
    ...
    try {
      ...
      console.error("Race hub Google signup:", err);
  ...
  const handleEmailSignUp = async (e: React.FormEvent) => {
    ...
    try {
      ...
      console.error("Race hub email signup:", err);
    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center p-4">
        <div className="max-w-md w-full bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600 mb-4">Failed to load race.</p>
          <Link href="/races" className="inline-block bg-orange-500 hover:bg-orange-600 text-white px-4 py-2 rounded-lg">
            My Races
          </Link>
        </div>
            ...
            <div className="flex justify-center mb-4">
              ...
              (race.logoUrl.startsWith("http") || race.logoUrl.startsWith("/")) ? (
                <img
                  src={race.logoUrl}
                  alt=""
                  className="w-16 h-16 rounded-xl object-contain border-2 border-gray-200 p-1"
                />
              ) : (
          ...
          {!showEmailForm ? (
            <div className="space-y-3">
              <button
                ...
                disabled={loading}
                className="w-full flex items-center justify-center gap-3 bg-white hover:bg-gray-50 border-2 border-gray-300 text-gray-900 px-6 py-3 rounded-xl font-semibold text-lg transition shadow-lg disabled:opacity-50"
              >
                {loading ? (
                  <>
            ...
            <form onSubmit={handleEmailSignUp} className="space-y-3">
              ...
              <div className="flex gap-2">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="flex-1 bg-orange-500 hover:bg-orange-600 text-white py-3 px-6 rounded-xl font-semibold transition shadow-lg disabled:opacity-50"
                >
