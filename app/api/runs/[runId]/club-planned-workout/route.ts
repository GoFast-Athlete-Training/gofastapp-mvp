...
/** POST /api/runs/[runId]/club-planned-workout — upsert club session prescribe template */
export async function POST(request: NextRequest, context: Ctx) {
  try {
    ...
    const planned = await upsertClubPlannedWorkoutForRun({
      cityRunId: runId,
      title: body.title || "",
    ...
    console.error("POST /api/runs/[runId]/club-planned-workout:", error);
    return NextResponse.json(
