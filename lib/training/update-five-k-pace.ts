/**
 * Adjust Athlete.fiveKPace from a workout quality score (0–100).
...
/** Map pace delta (target - actual sec/mile, positive = beat target) to 0–100 quality for updateFiveKPace */
