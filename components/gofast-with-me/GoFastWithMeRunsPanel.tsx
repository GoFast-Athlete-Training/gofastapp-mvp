...
type Props = {
  athleteId: string;
  publicSlug: string;
  /** Compact block for Runs workspace — no page header or plan footer. */
  embedded?: boolean;
      ...
      {!embedded ? (
        <div>
          ...
          <p className="text-sm text-gray-600 mt-1">
            Host joinable runs for your audience. Followers RSVP through GoRun.
          </p>
        </div>
      ) : null}
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="text-xs text-gray-600 mt-1">
              Upcoming join-me runs followers can RSVP to from your member hub.
            </p>
          </div>
        </div>
